...
const Hero = () => {
  return (
    <section id="home" className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-white dark:from-dark-800 dark:to-dark-900 transition-colors duration-300">
      <div className="container mx-auto px-4 text-center">
        ...
        >
          <h1 className="text-4xl md:text-6xl font-bold text-gray-800 dark:text-gray-200 mb-4">
            Hi, I'm <span className="text-blue-600 dark:text-blue-400">Rachit Sharma</span>
          </h1>
